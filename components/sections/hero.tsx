...
const TRACK_1 = [
    "/hero-slider/black_white_photo1.webp",
    "/hero-slider/black_white_photo2.webp",
    "/hero-slider/black_white_photo3.webp",
    "/hero-slider/black_white_photo4.webp",
    "/hero-slider/black_white_photo5.webp",
] as const;
